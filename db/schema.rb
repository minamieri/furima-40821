...
ActiveRecord::Schema[7.0].define(version: 2024_09_14_112130) do
  ...
  create_table "shippings", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_history_id"], name: "index_shippings_on_order_history_id"
  end
  ...
  create_table "users", charset: "utf8", force: :cascade do |t|
    ...
    t.string "full_width_lastname", null: false
    t.string "full_width_firstname", null: false
  ...
  add_foreign_key "shippings", "order_histories"
end
